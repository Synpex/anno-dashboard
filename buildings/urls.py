...
from buildings.views.html_views import buildings_view, import_detail_view, import_images_view, import_timeline_view, import_position_view, import_review_view
